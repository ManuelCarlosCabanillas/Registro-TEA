...
async function taskParse(p) {
  ...
  const sys =
    ...
    '"dys" (desajuste/rabieta/crisis/bloqueo/desregulación), "obs" (observación de estado suelta), "salud" (cuerpo/salud: caca/POPO, pipí, calambres, palpitaciones, dolor, mocos, medicación), "nap" (SIESTA diurna), "sleep" (SOLO el sueño nocturno de anoche).\n' +
